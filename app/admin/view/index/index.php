...
<html>
<head>
<title>{:vconfig('sys_title','后台管理')} - {:vconfig('site_title','快帮云建站')}</title>
<meta charset="utf-8"/>
...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        <div class="layui-logo"><cite>&nbsp;{:vconfig('sys_title','后台管理系统')}</cite></div>
    ...
    <!-- 底部 -->
    <div class="layui-footer layui-text">copyright © 2023 <a href="https://www.kbyun.cn" target="_blank">快帮云建站</a> </div>
</div>
<!-- 加载动画 -->
